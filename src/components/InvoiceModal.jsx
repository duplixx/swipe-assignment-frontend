...
const GenerateInvoice = (info, products, currency, total, taxAmount, discountAmount) => {
...
const InvoiceModal = (props) => {
  const { showModal, closeModal, info, products, currency, total, taxAmount, discountAmount } = props;
      ...
      <div id="invoiceCapture">
        <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
          <div className="w-100">
            ...
            <h7 className="fw-bold text-secondary mb-1">Invoice No.: {info.invoiceNumber || ""}</h7>
          </div>
        ...
        <Row>
          <Col md={6}>
            <Button
              ...
              onClick={() => GenerateInvoice(info, products, currency, total, taxAmount, discountAmount)}
            >
              <BiPaperPlane
